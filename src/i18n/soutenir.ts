...
const content: Record<Lang, SoutenirContent> = {
  fr: {
    ...
    widget: {
      ...
      secure: "Paiement 100 % sécurisé via Stripe", impactOnce: "Votre don finance {}.", impactMonthly: "Chaque mois, vous financez {}.",
  ...
  en: {
    ...
    widget: {
      ...
      secure: "100% secure payment via Stripe", impactOnce: "Your donation funds {}.", impactMonthly: "Each month, you fund {}.",
  ...
  de: {
    ...
    widget: {
      ...
      secure: "100 % sichere Zahlung über Stripe", impactOnce: "Ihre Spende finanziert {}.", impactMonthly: "Jeden Monat finanzieren Sie {}.",
