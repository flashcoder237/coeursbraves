...
const content: Record<Lang, HistContent> = {
  fr: {
    ...
    founder: { eyebrow: "Le fondateur", title: "Une histoire profondément", accent: "humaine.", lead1: "L'histoire de Cœurs Braves est intimement liée au parcours de son fondateur,", lead2: ". Comme beaucoup de jeunes Africains, il a connu les défis de l'entrepreneuriat, les périodes d'incertitude et les obstacles liés à la mobilité internationale.", quote: "La réussite prend tout son sens lorsqu'elle devient un levier pour ouvrir des perspectives à d'autres." },
  ...
  en: {
    ...
    founder: { eyebrow: "The founder", title: "A deeply human", accent: "story.", lead1: "The story of Cœurs Braves is deeply tied to the journey of its founder,", lead2: ". Like many young Africans, he faced the challenges of entrepreneurship, periods of uncertainty and the obstacles of international mobility.", quote: "Success takes on its full meaning when it becomes a lever to open up prospects for others." },
  ...
  de: {
    ...
    founder: { eyebrow: "Der Gründer", title: "Eine zutiefst", accent: "menschliche Geschichte.", lead1: "Die Geschichte von Cœurs Braves ist eng mit dem Werdegang ihres Gründers verbunden,", lead2: ". Wie viele junge Afrikaner erlebte er die Herausforderungen des Unternehmertums, Phasen der Unsicherheit und die Hürden internationaler Mobilität.", quote: "Erfolg entfaltet seinen vollen Sinn, wenn er zum Hebel wird, um anderen Perspektiven zu eröffnen." },
