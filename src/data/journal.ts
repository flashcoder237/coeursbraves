...
export const articles: Article[] = [
  {
    ...
    body: [
      ...
      { h: "Un lieu de rencontre", text: "La Marmite est aussi un lieu de vie : on y partage un repas, on y échange, on y crée du lien. C'est cette convivialité, au cœur des communautés, qui donne tout son sens au projet." },
    ],
  },
  {
  ...
  },
  {
    ...
    date: "2 mars 2024",
    iso: "2024-03-02",
    image: "/images/cb/agri-cacao.jpg",
